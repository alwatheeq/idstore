...
begin
 ...
 payload:=jsonb_build_object('task_id',task,'expected_attempt',0,'result','pass','recorded_on_behalf','false');
...
$$;
select 'Simplified inspection fields and admin permission tests passed; all fixtures rolled back' as result;
rollback;
