-- Restore behavior only; retain additive columns/indexes and saved follow-ups.
...
$function$;
revoke execute on function public.reschedule_vehicle_followup(uuid,date,timestamptz) from authenticated;
