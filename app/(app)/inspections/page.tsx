...
export default async function InspectionsPage({ searchParams }: { searchParams: Promise<Query> }) {
  ...
  const selected = visible.find(i => i.id === query.inspection) ?? visible.find(i => i.repair_order_id === query.order);
