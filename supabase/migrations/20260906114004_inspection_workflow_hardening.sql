-- Model-specific overrides win only when their applicability rules match.
...
create or replace function public.inspection_workflow(p_inspection_id uuid,p_action text,p_data jsonb default '{}') returns jsonb
